...
namespace Repositories.RepoConcretes
{
	...
	{
		Task<PagedList<Workout>?> GetAllWorkoutsByUserIdAsync(WorkoutParameters workoutParameters, string userId, bool trackChanges);
		...
		Task<int> WorkoutCountAsync(string userId);
	}
}
